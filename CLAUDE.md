...
This project is indexed by GitNexus as **dmr-X** (6364 symbols, 15213 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
