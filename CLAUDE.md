...
This project is indexed by GitNexus as **dmr-X** (8594 symbols, 21851 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
