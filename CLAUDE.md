...
This project is indexed by GitNexus as **dmr-X** (7167 symbols, 15210 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
