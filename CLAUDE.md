...
This project is indexed by GitNexus as **dmr-X** (4796 symbols, 10179 relationships, 252 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
