...
This project is indexed by GitNexus as **dmr-X** (4914 symbols, 10498 relationships, 258 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
