...
This project is indexed by GitNexus as **dmr-X** (11479 symbols, 27880 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
