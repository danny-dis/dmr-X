...
This project is indexed by GitNexus as **dmr-X** (10430 symbols, 24897 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
