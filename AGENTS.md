...
This project is indexed by GitNexus as **dmr-X** (14802 symbols, 36191 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
