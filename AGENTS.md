...
This project is indexed by GitNexus as **dmr-X** (11392 symbols, 27712 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
