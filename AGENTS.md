...
This project is indexed by GitNexus as **dmr-X** (8135 symbols, 16749 relationships, 240 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
