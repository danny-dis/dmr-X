...
This project is indexed by GitNexus as **dmr-X** (10486 symbols, 25329 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
