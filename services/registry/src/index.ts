...
export { PROVIDER_CATALOG, getProviderTemplate, getProvidersByCategory, getProvidersByModality, searchProviders, type ProviderTemplate, type ModelTemplate, type OAuthProviderConfig, type PricingTier } from './provider-catalog.js';
export { autoRegisterProviders, discoverMissingModels, enrichExistingModels, repairModelProfiles } from './auto-register.js';
