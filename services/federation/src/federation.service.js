...
export class FederationService {
    ...
    getById(id) {
        const db = getDb();
        const row = db.prepare('SELECT * FROM federation_nodes WHERE id = ?').get(id);
    ...
    list() {
        ...
        const db = getDb();
        const rows = db.prepare('SELECT * FROM federation_nodes ORDER BY created_at DESC').all();
...
//# sourceMappingURL=federation.service.js.map