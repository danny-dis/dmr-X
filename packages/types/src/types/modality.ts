...
export type TaskCategory =
  ...
  | 'reasoning'         // Chain-of-thought, complex logic
  | 'code'              // Code generation, debugging
  | 'analysis'          // Data analysis, document analysis
  | 'creative'          // Creative writing, storytelling
  | 'classification'    // Text classification, extraction
  | 'translation'       // Cross-lingual tasks
  | 'embedding'         // Vector encoding
  | 'reranking'         // Document reordering
  | 'tts'               // Text-to-speech
  | 'stt'               // Speech-to-text
  | 'vision'            // Image understanding
  | 'image_generation'  // Image synthesis
  | 'video'             // Video generation
  | 'security'          // Cybersecurity, vulnerability analysis
...
/**
 * License type — legal terms for using the model.
 */
export type ModelLicense = 'open_weight' | 'open_source' | 'proprietary' | 'api_only';
