...
export const PROVIDER_CATALOG: ProviderTemplate[] = [
...

  {
    ...
    models: [
      ...
      { id: 'mistral-small-4', modalities: ['llm'], contextWindow: 256000, inputCostPer1M: 0, outputCostPer1M: 0, capabilities: ['tool_use', 'json_mode', 'streaming', 'vision'], specializations: ['general'], freeTier: { rateLimits: { rpm: 60, rpd: 0, tpm: 500000, tpd: 0 }, monthlyTokenBudget: 0, intelligenceRank: 8, speedRank: 8 } },
      { id: 'mistral-medium-3.5', modalities: ['llm'], contextWindow: 256000, inputCostPer1M: 0, outputCostPer1M: 0, capabilities: ['tool_use', 'json_mode', 'streaming', 'vision'], specializations: ['general'], freeTier: { rateLimits: { rpm: 60, rpd: 0, tpm: 500000, tpd: 0 }, monthlyTokenBudget: 0, intelligenceRank: 8, speedRank: 7 } },
  ...
  // ═══════════════════════════════════════════════════════════
  // CARRIED OVER FROM OMNIROUTE (feature/omniroute-ux-research)
  // OpenAI-compatible aggregators + single providers missing from DMR-X.
  // Verified baseUrls sourced from OmniRoute's provider registry.
  // ═══════════════════════════════════════════════════════════

  {
    ...
    modalities: ['llm'],
    models: [
      { id: 'gpt-4o', modalities: ['llm'], contextWindow: 128000, capabilities: ['vision', 'tool_use', 'streaming'], specializations: ['general'] },
      { id: 'claude-3-5-sonnet-20241022', modalities: ['llm'], contextWindow: 200000, capabilities: ['vision', 'tool_use', 'streaming'], specializations: ['ui_design'] },
      { id: 'gemini-1.5-pro', modalities: ['llm'], contextWindow: 2000000, capabilities: ['vision', 'tool_use', 'streaming'], specializations: ['general'] },
      { id: 'meta-llama/Meta-Llama-3.1-70B-Instruct-Turbo', modalities: ['llm'], contextWindow: 131072, capabilities: ['tool_use', 'streaming'], specializations: ['general'] },
      { id: 'deepseek-chat', modalities: ['llm'], contextWindow: 64000, capabilities: ['tool_use', 'streaming'], specializations: ['coding'] },
      { id: 'mistral-large-latest', modalities: ['llm'], contextWindow: 128000, capabilities: ['tool_use', 'streaming'], specializations: ['general'] },
    ],
    streaming: true,
    toolCalling: true,
    envKey: 'AIMLAPI_KEY',
    description: '200+ models via a single OpenAI-compatible aggregator endpoint. $0.025/day free credits.',
    region: 'global',
  ...
  },
  {
    ...
    name: 'Chutes AI',
    category: 'cloud_llm',
    baseUrl: 'https://api.chutesai.com/v1',
    authMethod: 'bearer',
    apiFormat: 'openai',
    modalities: ['llm'],
    models: [
    ...
    description: 'Open-source model hosting with OpenAI-compatible API (Qwen, Llama, DeepSeek).',
    region: 'global',
  ...
  },
  {
    ...
    modalities: ['llm'],
    models: [
      { id: 'meta-llama-3.3-70b-instruct', modalities: ['llm'], contextWindow: 131072, capabilities: ['tool_use', 'streaming'], specializations: ['general'] },
      { id: 'mistralai/Mixtral-8x7B-Instruct-v0.1', modalities: ['llm'], contextWindow: 32768, capabilities: ['tool_use', 'streaming'], specializations: ['general'] },
    ],
    streaming: true,
    toolCalling: true,
    envKey: 'FRIENDLIAI_API_KEY',
    description: 'Serverless LLM inference, OpenAI-compatible. High-throughput optimized endpoints.',
    region: 'global',
  ...
  },
  {
    ...
    modalities: ['llm'],
    models: [
      { id: 'venice-uncensored', modalities: ['llm'], contextWindow: 128000, capabilities: ['streaming'], specializations: ['general'] },
      { id: 'llama-3.3-70b', modalities: ['llm'], contextWindow: 131072, capabilities: ['tool_use', 'streaming'], specializations: ['general'] },
    ],
    streaming: true,
    toolCalling: true,
    envKey: 'VENICE_API_KEY',
    description: 'Privacy-focused, uncensored models via OpenAI-compatible API.',
    region: 'global',
  ...
  },
  {
    ...
    name: 'GLHF Chat',
    category: 'cloud_llm',
    baseUrl: 'https://api.laf.run/v1',
    authMethod: 'bearer',
    apiFormat: 'openai',
    modalities: ['llm'],
    models: [
      { id: 'deepseek-7b-chat', modalities: ['llm'], contextWindow: 32000, capabilities: ['streaming'], specializations: ['fast', 'cheap'] },
    ],
    streaming: true,
    toolCalling: false,
    envKey: 'GLHF_API_KEY',
    description: 'Open-source models hosted on GLHF (laf.run), OpenAI-compatible.',
    region: 'global',
  ...
  },
  {
    ...
    models: [
      { id: 'gpt-4o', modalities: ['llm'], contextWindow: 128000, capabilities: ['vision', 'tool_use', 'streaming'], specializations: ['general'] },
      { id: 'claude-3-5-sonnet', modalities: ['llm'], contextWindow: 200000, capabilities: ['vision', 'tool_use', 'streaming'], specializations: ['ui_design'] },
    ],
    streaming: true,
    toolCalling: true,
    envKey: 'NANOGPT_API_KEY',
    description: 'Pay-per-use aggregator for GPT/Claude/Gemini via OpenAI-compatible API.',
    region: 'global',
  ...
  },
  {
    ...
    modalities: ['llm'],
    models: [
      { id: 'auto', modalities: ['llm'], contextWindow: 128000, capabilities: ['tool_use', 'streaming'], specializations: ['general'] },
      { id: 'anthropic/claude-3.5-sonnet', modalities: ['llm'], contextWindow: 200000, capabilities: ['vision', 'tool_use', 'streaming'], specializations: ['ui_design'] },
    ],
    streaming: true,
    toolCalling: true,
    envKey: 'REQUESTY_API_KEY',
    description: 'LLM router with smart fallback across providers. OpenAI-compatible.',
    region: 'global',
  ...
  },
  {
    ...
    category: 'cloud_llm',
    baseUrl: 'https://inference.do-ai.io/v1',
    authMethod: 'bearer',
    apiFormat: 'openai',
    modalities: ['llm'],
    models: [
      { id: 'llama3-3-70b', modalities: ['llm'], contextWindow: 131072, capabilities: ['tool_use', 'streaming'], specializations: ['general'] },
    ],
    streaming: true,
    toolCalling: true,
    envKey: 'DIGITALOCEAN_API_KEY',
    description: 'DigitalOcean serverless GPU inference platform, OpenAI-compatible.',
    region: 'us',
    signupUrl: 'https://www.digitalocean.com/products/genai-platform',
  },
  {
    id: 'predibase',
    name: 'Predibase',
    ...
    modalities: ['llm'],
    models: [
      { id: 'meta-llama/Llama-3.3-70B-Instruct', modalities: ['llm'], contextWindow: 131072, capabilities: ['tool_use', 'streaming'], specializations: ['general'] },
    ],
    streaming: true,
    toolCalling: true,
    envKey: 'PREDIBASE_API_KEY',
    description: 'Fine-tuning and serving platform for open models, OpenAI-compatible.',
    region: 'us',
    signupUrl: 'https://predibase.com/',
  },
  {
    id: 'nvidia',
    name: 'NVIDIA NIM',
    ...
    models: [
      { id: 'meta/llama-3.3-70b-instruct', modalities: ['llm'], contextWindow: 131072, capabilities: ['tool_use', 'streaming'], specializations: ['general'] },
      { id: 'mistralai/mistral-large-3', modalities: ['llm'], contextWindow: 131072, capabilities: ['tool_use', 'streaming'], specializations: ['general'] },
      { id: 'nvidia/nemotron-70b-instruct', modalities: ['llm'], contextWindow: 131072, capabilities: ['tool_use', 'streaming'], specializations: ['general'] },
      { id: 'deepseek-ai/deepseek-v3', modalities: ['llm'], contextWindow: 64000, capabilities: ['tool_use', 'streaming'], specializations: ['coding'], reasoningMode: 'adaptive' },
    ],
    streaming: true,
    toolCalling: true,
    envKey: 'NVIDIA_API_KEY',
    description: 'NVIDIA-hosted open-model endpoints (NIM microservices), OpenAI-compatible.',
    region: 'global',
    signupUrl: 'https://build.nvidia.com/',
  },
  {
    ...
    modalities: ['llm'],
    models: [
      { id: 'gemini-2.5-pro', modalities: ['llm'], contextWindow: 1000000, capabilities: ['vision', 'tool_use', 'streaming'], specializations: ['reasoning', 'coding'] },
      { id: 'gemini-2.5-flash', modalities: ['llm'], contextWindow: 1000000, capabilities: ['vision', 'tool_use', 'streaming'], specializations: ['fast', 'cheap'] },
      { id: 'claude-sonnet-4-5', modalities: ['llm'], contextWindow: 200000, capabilities: ['vision', 'tool_use', 'streaming'], specializations: ['ui_design'] },
    ],
    streaming: true,
    toolCalling: true,
    envKey: 'GOOGLE_VERTEX_API_KEY',
    description: 'Google Cloud Vertex AI — Gemini + partner models (Claude, DeepSeek, Qwen) via Gemini API format.',
    region: 'global',
  ...
  },
  {
    ...
    models: [
      { id: 'anthropic.claude-3-5-sonnet', modalities: ['llm'], contextWindow: 200000, capabilities: ['vision', 'tool_use', 'streaming'], specializations: ['ui_design'] },
      { id: 'anthropic.claude-3-5-haiku', modalities: ['llm'], contextWindow: 200000, capabilities: ['vision', 'tool_use', 'streaming'], specializations: ['fast', 'cheap'] },
      { id: 'anthropic.claude-opus-4', modalities: ['llm'], contextWindow: 200000, capabilities: ['vision', 'tool_use', 'streaming'], specializations: ['reasoning', 'architecture'] },
      { id: 'amazon.nova-pro-v1:0', modalities: ['llm'], contextWindow: 300000, capabilities: ['vision', 'tool_use', 'streaming'], specializations: ['general'] },
      { id: 'meta.llama3-3-70b-instruct-v1:0', modalities: ['llm'], contextWindow: 131072, capabilities: ['tool_use', 'streaming'], specializations: ['general'] },
    ],
    streaming: true,
    toolCalling: true,
    envKey: 'AWS_BEDROCK_API_KEY',
    description: 'AWS-managed foundation models (Claude, Llama, Nova, Titan) — OpenAI-compatible invoke path.',
    region: 'us',
  ...
  },
  {
    ...
    modalities: ['llm'],
    models: [
      { id: 'qwen-max', modalities: ['llm'], contextWindow: 32768, capabilities: ['vision', 'tool_use', 'streaming'], specializations: ['general'] },
      { id: 'qwen-plus', modalities: ['llm'], contextWindow: 32768, capabilities: ['tool_use', 'streaming'], specializations: ['general'] },
      { id: 'qwen2.5-72b-instruct', modalities: ['llm'], contextWindow: 131072, capabilities: ['tool_use', 'streaming'], specializations: ['general'] },
      { id: 'qwen2.5-coder-32b-instruct', modalities: ['llm'], contextWindow: 32768, capabilities: ['tool_use', 'streaming'], specializations: ['coding'] },
      { id: 'qwen-vl-max', modalities: ['llm'], contextWindow: 32768, capabilities: ['vision', 'streaming'], specializations: ['vision'] },
    ],
    streaming: true,
    toolCalling: true,
    envKey: 'DASHSCOPE_API_KEY',
    description: 'Alibaba Qwen family (DashScope) — text, coder, and vision models, OpenAI-compatible.',
    region: 'cn',
    signupUrl: 'https://dashscope.console.aliyun.com/',
  },
  {
    ...
    modalities: ['llm'],
    models: [
      { id: 'hunyuan-turbo', modalities: ['llm'], contextWindow: 32768, capabilities: ['tool_use', 'streaming'], specializations: ['general'] },
      { id: 'hunyuan-standard', modalities: ['llm'], contextWindow: 32768, capabilities: ['streaming'], specializations: ['general'] },
      { id: 'hunyuan-vision', modalities: ['llm'], contextWindow: 32768, capabilities: ['vision', 'streaming'], specializations: ['vision'] },
    ],
    streaming: true,
    toolCalling: true,
    envKey: 'HUNYUAN_API_KEY',
    description: 'Tencent Hunyuan LLM — OpenAI-compatible chat + vision.',
    region: 'cn',
  ...
  },
  {
    ...
    modalities: ['llm'],
    models: [
      { id: 'SenseNova-V6-Turbo', modalities: ['llm'], contextWindow: 32768, capabilities: ['vision', 'tool_use', 'streaming'], specializations: ['general'] },
      { id: 'SenseNova-V6-Pro', modalities: ['llm'], contextWindow: 32768, capabilities: ['vision', 'tool_use', 'streaming'], specializations: ['reasoning'] },
    ],
    streaming: true,
    toolCalling: true,
    envKey: 'SENSENOVA_API_KEY',
    description: 'SenseTime SenseNova large models — OpenAI-compatible.',
    region: 'cn',
    signupUrl: 'https://www.sensetime.com/',
  },
  {
    id: 'volcengine',
    ...
    modalities: ['llm'],
    models: [
      { id: 'doubao-seed-1.6', modalities: ['llm'], contextWindow: 256000, capabilities: ['vision', 'tool_use', 'streaming'], specializations: ['general'] },
      { id: 'doubao-pro-32k', modalities: ['llm'], contextWindow: 32768, capabilities: ['tool_use', 'streaming'], specializations: ['general'] },
      { id: 'doubao-vision-pro-32k', modalities: ['llm'], contextWindow: 32768, capabilities: ['vision', 'streaming'], specializations: ['vision'] },
    ],
    streaming: true,
    toolCalling: true,
    envKey: 'VOLCENGINE_ARK_API_KEY',
    description: 'ByteDance Volcengine Ark — Doubao models, OpenAI-compatible.',
    region: 'cn',
  ...
  },
  {
    ...
    modalities: ['llm'],
    models: [
      { id: 'step-2-16k', modalities: ['llm'], contextWindow: 16384, capabilities: ['tool_use', 'streaming'], specializations: ['general'] },
      { id: 'step-1.5v-mini', modalities: ['llm'], contextWindow: 32768, capabilities: ['vision', 'streaming'], specializations: ['vision'] },
    ],
    streaming: true,
    toolCalling: true,
    envKey: 'STEPFUN_API_KEY',
    description: 'StepFun (Jieyue Xingchen) multimodal models — OpenAI-compatible.',
    region: 'cn',
    signupUrl: 'https://www.stepfun.com/',
  },
  {
    id: 'qianfan',
    name: 'Baidu Qianfan',
    ...
    modalities: ['llm'],
    models: [
      { id: 'ernie-4.5-8k', modalities: ['llm'], contextWindow: 8192, capabilities: ['tool_use', 'streaming'], specializations: ['general'] },
      { id: 'ernie-4.5-vl-8k', modalities: ['llm'], contextWindow: 8192, capabilities: ['vision', 'streaming'], specializations: ['vision'] },
      { id: 'deepseek-v3', modalities: ['llm'], contextWindow: 64000, capabilities: ['tool_use', 'streaming'], specializations: ['coding'] },
    ],
    streaming: true,
    toolCalling: true,
    envKey: 'QIANFAN_API_KEY',
    description: 'Baidu AI Studio Qianfan — ERNIE + open models, OpenAI-compatible.',
    region: 'cn',
  ...
  },
  {
    ...
    modalities: ['llm'],
    models: [
      { id: 'generalv3.5', modalities: ['llm'], contextWindow: 32768, capabilities: ['tool_use', 'streaming'], specializations: ['general'] },
      { id: 'pro-128k', modalities: ['llm'], contextWindow: 131072, capabilities: ['streaming'], specializations: ['general'] },
    ],
    streaming: true,
    toolCalling: true,
    envKey: 'SPARKDESK_API_KEY',
    description: 'iFlytek SparkDesk cognitive model — OpenAI-compatible.',
    region: 'cn',
