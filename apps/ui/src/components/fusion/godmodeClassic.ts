// ═══════════════════════════════════════════════════════════════════
// L1B3RT4S — Hall of Fame: Proven Model + Prompt Combos (client-side)
//
// Copied verbatim from the G0DM0D3 source (src/lib/libertas.ts).
// These are consumed entirely client-side — G0DM0D3 has NO server route
// for them. We build the system/user prompts locally via applyHallOfFameCombo
// and POST to DMR-X's existing godmode chat proxy (POST /v1/godmode/chat).
// ═══════════════════════════════════════════════════════════════════
