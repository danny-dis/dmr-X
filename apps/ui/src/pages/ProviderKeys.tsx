...
import { Key, Search, Copy, Clock, ShieldCheck, Activity, Plug, CheckCircle2, XCircle, Loader2, X, ExternalLink } from 'lucide-react';
          ...
          return (
            <div key={key.id} className="glass-card rounded-xl p-4 hover:border-[#F7A51C]/20 transition-all">
              ...
              <div className="flex items-center justify-between text-[11px]">
                <div className="flex items-center gap-3">
                  {provider && (
                    <span className="text-[#A6A6B0] flex items-center gap-1">
                      {provider.name}
                      {provider.signupUrl && (
                        <a
                          ...
                          className="text-[#F7A51C] hover:text-[#F8F9FC] transition-colors"
                          title="Get API key"
                        >
