export function EmptyProviders({ size = 120, className = '' }) {
    return (<svg width={size} height={size} viewBox="0 0 120 120" fill="none" className={className}>
...
export function EmptyRequests({ size = 120, className = '' }) {
    return (<svg width={size} height={size} viewBox="0 0 120 120" fill="none" className={className}>
...
export function EmptyCharts({ size = 120, className = '' }) {
    return (<svg width={size} height={size} viewBox="0 0 120 120" fill="none" className={className}>
...
export function EmptySettings({ size = 120, className = '' }) {
    return (<svg width={size} height={size} viewBox="0 0 120 120" fill="none" className={className}>
...
export function EmptySearch({ size = 120, className = '' }) {
    return (<svg width={size} height={size} viewBox="0 0 120 120" fill="none" className={className}>
...
export function EmptyError({ size = 120, className = '' }) {
    return (<svg width={size} height={size} viewBox="0 0 120 120" fill="none" className={className}>
