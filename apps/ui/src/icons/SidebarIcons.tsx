...
export function BrandWordmark({ height = 22, ...props }: IconProps) {
  return (
    <svg height={height} viewBox="0 0 130 32" fill="none" {...props}>
      <defs>
...
export function WorkersIcon(props: IconProps) {
  return (
    <svg {...base(props)}>
      <circle cx="12" cy="4" r="1.5" />
