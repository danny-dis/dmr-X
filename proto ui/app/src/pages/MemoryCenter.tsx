...
import { Search, Layers, Construction } from 'lucide-react';
    ...
    <div className="space-y-4">
      ...
      <div className="flex items-center gap-3 px-4 py-3 bg-[#F7A51C]/10 border border-[#F7A51C]/30 rounded-lg">
        ...
        <div>
          ...
          <div className="text-[11px] text-[#F7A51C]/70">Memory Center is a planned feature for memory storage, retrieval, and embedding management. This page shows mock data for preview purposes.</div>
        </div>
      </div>
